import { getProjectTeam, removerUserFromProject } from "@/api/TeamApi"
...
export default function ProjectTeamView() {
    ...
    const {mutate}=useMutation({
        mutationFn: removerUserFromProject,
        onError:(error)=>{
...
if(data) return (
    <>
        <h1 className="text-5xl font-black">Administrar Equipo</h1>
            <p className="text-2xl font-light text-gray-500 mt-5"> Administrar Equipo De trabajo de este proyecto</p>
